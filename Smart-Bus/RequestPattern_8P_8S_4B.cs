...
namespace Smart_Bus
{
    class RequestPattern_8P_8S_4B: IRequestPattern
    {
        ...
        {
            new Request(1, 1 * 1000, 11 * 1000, 0, 4), 
            new Request(2, 2 * 1000, 12 * 1000, 2, 7),
            new Request(3, 3 * 1000, 13 * 1000, 5, 1), 
            new Request(4, 4 * 1000, 14 * 1000, 1, 0),
            new Request(5, 5 * 1000, 15 * 1000, 6, 4), 
            new Request(6, 6 * 1000, 16 * 1000, 0, 3),
            new Request(7, 7 * 1000, 17 * 1000, 2, 1), 
            new Request(8, 8 * 1000, 18 * 1000, 6, 7) 
        };
